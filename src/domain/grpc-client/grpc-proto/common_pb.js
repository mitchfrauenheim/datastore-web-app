...
goog.exportSymbol('proto.AttributeNames', null, global);
 ...
 * @constructor
 */
proto.AttributeNames = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.AttributeNames.repeatedFields_, null);
};
goog.inherits(proto.AttributeNames, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.AttributeNames.displayName = 'proto.AttributeNames';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.AttributeNames.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.AttributeNames.prototype.toObject = function(opt_includeInstance) {
  return proto.AttributeNames.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.AttributeNames} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.AttributeNames.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 */
proto.AttributeNames.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.AttributeNames;
  return proto.AttributeNames.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.AttributeNames} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.AttributeNames}
 */
proto.AttributeNames.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.AttributeNames.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.AttributeNames.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.AttributeNames} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.AttributeNames.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Array<string>}
 */
proto.AttributeNames.prototype.getNameList = function() {
 ...
 * @return {!proto.AttributeNames} returns this
 */
proto.AttributeNames.prototype.setNameList = function(value) {
 ...
 * @return {!proto.AttributeNames} returns this
 */
proto.AttributeNames.prototype.addName = function(value, opt_index) {
 ...
 * @return {!proto.AttributeNames} returns this
 */
proto.AttributeNames.prototype.clearNameList = function() {
